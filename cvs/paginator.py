...
class MtracPaginator(Paginator):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(MtracPaginator, self).__init__(*args, **kwargs)
    ...
    def page(self, number, *args, **kwargs):
        ...
        try:
            page = super(MtracPaginator, self).page(number, *args, **kwargs)
            number = int(number) # we know this will work
        except InvalidPage, e:
            page = super(MtracPaginator, self).page(1, *args, **kwargs)
            number=1
...
def mtrac_paginate(objects_list,perpage,page,p):
    paginator = MtracPaginator(objects_list, perpage, body=12, padding=2)

...
def muac(request, location_id=None):
    ...
    if location_id:
        ...
        location = Area.tree.root_nodes()[0]
    total = report('muac', location=location, group_by = GROUP_BY_LOCATION, start_date=start_date, end_date=end_date,request=request)
    green = report('muac', attribute_keyword='category', attribute_value='G', location=location, group_by = GROUP_BY_LOCATION, start_date=start_date, end_date=end_date, request=request)
    green_oedema = report('muac', attribute_keyword=['category', 'oedema'], attribute_value=['G','T'], location=location, group_by = GROUP_BY_LOCATION, start_date=start_date, end_date=end_date, request=request)
#    green_oedema = green.filter(muac_oedma='T');
    yellow = report('muac', attribute_keyword='category', attribute_value='Y', location=location, group_by = GROUP_BY_LOCATION, start_date=start_date, end_date=end_date, request=request)
    red = report('muac', attribute_keyword='category', attribute_value='R', location=location, group_by = GROUP_BY_LOCATION, start_date=start_date, end_date=end_date, request=request)
#    red_oedema = report('muac', attribute_keyword='oedema', attribute_value='T', location=location, group_by = GROUP_BY_LOCATION, start_date=start_date, end_date=end_date, request=request)
    red_oedema = report('muac', attribute_keyword=['category', 'oedema'], attribute_value=['R','T'], location=location, group_by = GROUP_BY_LOCATION, start_date=start_date, end_date=end_date, request=request)
    report_dict = {}
...
def epi(request, location_id=None):
    ...
    report_dict = {}
    total = report('epi', location=location, group_by = GROUP_BY_LOCATION, start_date=start_date, end_date=end_date,request=request)
    reorganize_location('total', total, report_dict)
    for attrib_keyword, v in categories:
        dictx = report('epi', attribute_keyword=attrib_keyword, location=location, group_by = GROUP_BY_LOCATION, start_date=start_date, end_date=end_date, request=request)
    ...
    chart = report('epi', location=location, start_date=start_date, end_date=end_date, group_by=GROUP_BY_WEEK | GROUP_BY_LOCATION | GROUP_BY_YEAR)
